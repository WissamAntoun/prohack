...
#%%
reg = TabNetRegressor(n_d=8, n_a=8, n_steps=3, gamma=1.3,
...
class sklearntabnetregressor(RegressorMixin):
  def __init__(self,n_d=8, n_steps=3, gamma=1.3,
    ...
    self.lr = lr
    self.seed = seed
    self.tabnet = TabNetRegressor(n_d = self.n_d, n_a = self.n_d, n_steps = self.n_steps, gamma = self.gamma,
